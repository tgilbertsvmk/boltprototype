...
export function ProfilerFlow({ onComplete }: ProfilerFlowProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Welcome to SurveyMonkey</h1>
          <p className="text-lg text-gray-600">
            Help us understand your needs so we can create the perfect survey for you
          </p>
        </div>
